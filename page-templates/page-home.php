        ...
        <div class="swiper-wrapper container py-12 max-w-6xl w-full items-center">
            ...
            <div class="swiper-slide flex flex-col gap-12 justify-between px-8 md:flex-row md:gap-24">
                <div class="md:max-w-[524px] flex flex-col justify-center items-center md:items-start">
                    <h1
                        class="text-2xl font-bold text-center tracking-tight text-primary-shade md:text-3xl md:text-left">
                        <?= $slide["title"] ?>
                    </h1>
                    <p
                        class="mt-3 text-base text-gray-500 text-center sm:mx-auto sm:mt-5 sm:text-lg md:mt-5 md:text-xl lg:mx-0 md:text-left">
                        <?= $slide["description"] ?>
                    </p>
                    <a href="<?= $slide["button_url"] ?>"
                        class="py-4 px-12 text-lg font-bold mt-8 max-w-xs text-center text-primary-off-white rounded-md inline-block bg-primary-color transition-all duration-300 border border-primary-color hover:bg-primary-off-white hover:text-primary-color">
                        <?= $slide["button_text"] ?>
                    </a>
                </div>
        ...
        <div class="grid gap-8 lg:grid-cols-2">
            ...
            <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md">
                ...
                <div class="flex justify-between items-center">
                    <a href="<?= the_permalink(); ?>"
                        class="inline-flex items-center font-medium text-primary-color hover:underline">
                        Saiba mais
        ...
        <div class="-my-8 divide-y-2 divide-gray-100">
            <div class="py-8 flex flex-wrap flex-col gap-12">
                ...
                <div class="md:flex-grow">
                    ...
                    <a href="<?= get_field("_cmb_files_file") ?>" target="_blank"
                        class="text-green-500 inline-flex items-center mt-4 hover:underline">
                        Fazer download
                        <svg class="w-4 h-4 ml-2" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none"
                            stroke-linecap="round" stroke-linejoin="round">
                            <path d="M5 12h14"></path>
                    ...
                    <div>
                        <div class="bg-white py-8 px-6 rounded-b">
                            ...
                            <a href="<?php the_permalink() ?>"
                                class="inline-flex items-center mt-6 font-medium text-primary-color hover:underline">
                                Continuar lendo
