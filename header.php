            ...
            <nav class="px-2 sm:px-4 py-4">
                <div class="container flex relative flex-wrap justify-between items-center mx-auto">
                    <a href="<?= home_url() ?>" class="flex items-center gap-3">
                        <img src="<?= get_theme_file_uri("assets/img/logo-acaeam.svg"); ?>" alt="Logo ACAEAM"
                            class="w-11">
                        <span class="text-gray-900 text-xl font-bold whitespace-nowrap">ACAEAM</span>
                    </a>
                    <button data-collapse-toggle="navbar-default" type="button"
                        class="inline-flex items-center p-2 ml-3 text-sm text-primary-color rounded-lg md:hidden hover:bg-gray-100 focus:outline-none dark:text-gray-400 dark:hover:bg-primary-off-white dark:focus:primary-color-tint"
                    ...
                    <div class="hidden absolute top-8 w-full md:block md:w-auto md:relative md:top-0 z-50"
                        id="navbar-default">
