    <footer class="p-4 bg-primary-off-white md:p-8 lg:p-10">
        <div class="mx-auto max-w-screen-xl text-center">
            <a href="#" class="flex justify-center items-center text-2xl font-bold text-primary-color-shade gap-4">
                <img src="<?= get_theme_file_uri("assets/img/logo-acaeam.svg"); ?>" alt="Logo ACAEAM" class="w-11">
                ACAEAM
            </a>
            <p class="my-6 text-gray-500">Associação Cultural, Artística e Esportiva: Arte e Movimento.</p>
            <ul class="flex flex-wrap gap-2 justify-center items-center mb-6 text-primary-color-shade">
                <li>
                    <a href="#" class="flex gap-1 py-1 px-2 rounded-full bg-primary-color-tint text-white">
                        <svg class="w-5" x="0" y="0" viewBox="0 0 49.652 49.652"
                ...
                <li>
                    <a href="#" class="flex gap-1 py-1 px-2 rounded-full bg-primary-color-tint text-white">
                        <svg class="w-5" x="0" y="0" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512"
            ...
            <span class="text-sm text-gray-400 sm:text-center">© 2022 <a href="#" class="hover:underline">ACAEAM</a>.
